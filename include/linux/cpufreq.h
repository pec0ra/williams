...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SMOUTHASS)
extern struct cpufreq_governor cpufreq_gov_smouthass;
#define CPUFREQ_DEFAULT_GOVERNOR        (&cpufreq_gov_smouthass)
#endif
